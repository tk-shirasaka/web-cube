...
$(function () {
    ...
    var Parent = React.createClass({
        ...
        routerSub: function (data) {
            ...
            if (type === dataType.parts && data.unsaved) state.view = viewType.edit;
        ...
        render: function () {
            ...
            case viewType.edit :
                ...
                listView.push(<div><h4>{type + ": " + this.state.select[type].title}</h4><Form forms={formList} change={this.changeForm} /><button className="btn btn-primary pull-right" onClick={this.saveParts}>Save</button></div>);
                break;
            }
            return (
                <div>
