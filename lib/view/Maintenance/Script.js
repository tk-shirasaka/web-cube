...
$(function () {
    ...
    Parts.prototype.dataInit = function (parts, data) {
        ...
        parts.removed   = this.root.removed;
    ...
    Parts.prototype.setGallery = function () {
        exeAjax(
            "GET",
            "/maintenance/ajax_parts_gallery",
            null,
            function (res) {
                parts.gallery = res;
            }
            ...
            return (
                <div className="panel panel-success">
                    ...
                    <div className="panel-body">
                        {(this.props.gallery && this.props.gallery.length) ? this.props.gallery.map(function (parts) {
                            return (
    ...
    var PartsControl        = React.createClass({
        pageSave: function () {
            putFormData($saveForm, {Page: this.state.page});
                ...
                <div className="col-xs-3 col-md-3 col-sm-3">
                    <div className="panel panel-default" style={showOrHide(this.props.mode === PARTS)}>
                        ...
                        <ul className="list-group">
                            <button type="button" className="list-group-item" onClick={this.pageSelect}>Select<span className={selectIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(!parts.chkError())} onClick={this.pageSave}>Save<span className={selectIcon}></span></button>
                        </ul>
                    </div>
                    <div className="panel panel-default" style={showOrHide(this.props.mode === PARTS)}>
                        <div className="panel-heading">Parts</div>
                        <ul className="list-group">
                            <button type="button" className="list-group-item" onClick={this.partsAdd}>Add<span className={addIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(current)} onClick={this.partsEdit}>Edit<span className={editIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(current)} onClick={this.partsCopy}>Copy<span className={copyIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(current)} onClick={this.partsRemove}>Remove<span className={removeIcon}></span></button>
                        </ul>
                    </div>
                    <div className="panel panel-default">
                        <div className="panel-heading">Other</div>
                        <ul className="list-group">
                            <button type="button" className="list-group-item" style={showOrHide(this.props.mode === PARTS)} onClick={this.props.switchMode}>Gallery<span className={folderCloseIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(this.props.mode === GALLERY)} onClick={this.props.switchMode}>Gallery<span className={folderOpenIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(current && this.props.mode === PARTS)} onClick={this.partsZoom.bind(this, false)}>Forcus<span className={zoomInIcon}></span></button>
                            <button type="button" className="list-group-item" style={showOrHide(base && this.props.mode === PARTS)} onClick={this.partsZoom.bind(this, true)}>View Page<span className={zoomOutIcon}></span></button>
                        </ul>
                    </div>
                    <div className="panel panel-default" style={showOrHide(this.props.mode === PARTS)}>
                            ...
                            {this.props.ids.map(function (id) {
                                ...
                                return (
                                    <button type="button" className={className} style={showOrHide(showList)} onClick={this.updateList.bind(this, id)}>
                                        ...
                                        <span className={slideDownIcon} style={showOrHide(childNum && !showChild)}></span>
                                    </button>
                                );
                            }, this)}
                        </ul>
    ...
    var PartsContainer      = React.createClass({
        getInitialState: function () {
            return {ids: [], html: parts.html, page: {}, mode: PARTS};
        },
        ...
        render: function () {
            return (
                <div className="parts-container">
                    ...
                    <div id="parts-contents" className="col-xs-9 col-md-9 col-sm-9" style={showOrHide(this.state.mode === PARTS)}>
                        <div className="panel panel-success">
                    ...
                    <div className="col-xs-9 col-md-9 col-sm-9" style={showOrHide(this.state.mode === GALLERY)}>
                        <PartsGallery title="Shared Parts" gallery={parts.gallery.shared}/>
                        <PartsGallery title="My Gallery"   gallery={parts.gallery.user}/>
                    </div>
                </div>
            );
        }
