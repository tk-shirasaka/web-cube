...
$(function () {
                ...
                <div className="col-xs-3 col-md-3 col-sm-3">
                    <div className="panel panel-default">
                        ...
                        <ul id="ActionList" className="list-group">
                            <button id="PageEdit"       type="button" className="list-group-item           ">Page Select  <span className={selectIconClass}></span></button>
                            <button id="PartsNew"       type="button" className="list-group-item           ">New Parts    <span className={addIconClass}></span></button>
                            <button id="PartsEdit"      type="button" className="list-group-item parts-only">Edit Parts   <span className={editIconClass}></span></button>
                            <button id="PartsCopy"      type="button" className="list-group-item parts-only">Copy Parts   <span className={copyIconClass}></span></button>
                            <button id="PartsRemove"    type="button" className="list-group-item parts-only">Remove Parts <span className={removeIconClass}></span></button>
                            <button id="PartsAddChild"  type="button" className="list-group-item parts-only">Add Child    <span className={addIconClass}></span></button>
                            <button id="PartsZoomIn"  type="button" className="list-group-item parts-only">Zoom In    <span className={zoomInIconClass}></span></button>
                            <button id="PartsZoomOut" type="button" className="list-group-item           ">Zoom Out   <span className={zoomOutIconClass}></span></button>
                        </ul>
                    </div>
                    <div className="panel panel-default">
    ...
    function partsEdit() {
        ...
        $("#PartsList button").bind("click", function () {
            ...
            if (!parts.Child.length) $("#PartsZoomIn").slideUp();
