    ...
    var Parent = React.createClass({
        ...
        render: function () {
            ...
            case viewType.partsAttrForm :
                ...
                listView.push(<div><h4>Parts Form</h4><Form forms={formList} change={this.changeForm} /><div className="pager"><li className="previous" onClick={this.editParts}><a href="#">Prev</a></li></div></div>);
                break;
            }
            return (
                <div>
