...
$(function () {
            ...
            var list = this.props.ids.map(function (id) {
                ...
                return (
                    <button id={id} type="button" className="list-group-item" style={isChild}>
                        Title : {title}
                        <span className={hasChild + " show-child " + downIconClass}></span>
                        <span className={hasChild + " hide-child " + upIconClass}></span>
                    </button>
                );
            });
            return (
                <div className="col-xs-3 col-md-3 col-sm-3">
                    <div className="panel panel-default">
                        ...
                        <ul id="ActionList" className="list-group">
                            <button id="PageSelect"    type="button" className="list-group-item           ">Page Select  <span className={selectIconClass}></span></button>
    ...
    function partsEdit() {
        ...
        $("#PartsList button").bind("click", function () {
            ...
            var parts       = PartsClass.findById(id);
            var children    = [];
            var hidden      = $(this).hasClass("show-child");
