...
$(function () {
    var viewType    = {init: 1, page: 2, parts: 3, gallery: 4, pageForm: 5, partsForm: 6, partsAttrForm: 7, saved: 8};
    ...
    var Parent = React.createClass({
        ...
        selectPage: function (id) {
            this.exeAjax("POST", "/maintenance/ajax_page_render", {page: id}, {view: viewType.parts, dirty: true, select: null});
        },
        ...
        removeParts: function () {
            this.exeAjax("POST", "/maintenance/ajax_parts_remove", this.state.select, {view: viewType.saved});
        ...
        saveParts: function () {
            ...
            this.exeAjax("POST", "/maintenance/ajax_parts_save", this.state.select, {view: viewType.saved});
            this.selectPage(this.state.parts.Page.id);
        },
        ...
        getNavi: function () {
            var naviList    = [];
            naviList.push({title: "Home", state: {view: viewType.page, select: null}});
